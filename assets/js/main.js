;(function () {
  ...
  $("#all-section").click(function () {
    ...
    $(this).css("background"," #B7092B")
    $("#event-section").css("background","#01036f")
    $("#project-section").css("background","#01036f")
  })
  
  $("#event-section").click(function () {
    $(".event-item").show(500)
$(".project-item").hide(500)
$(this).css("background"," #B7092B")
$("#all-section").css("background","#01036f")
$("#project-section").css("background","#01036f")
  })
