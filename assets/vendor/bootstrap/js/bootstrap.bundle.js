  ...
  */
  ...
  function preventOverflow(_ref) {
    ...
    var _options$mainAxis = options.mainAxis,
      ...
      tetaboutffset =
        _options$tetaboutffset === void 0 ? 0 : _options$tetaboutffset
    var overflow = detectOverflow(state, {
      boundary: boundary,
      rootBoundary: rootBoundary,
      padding: padding,
    ...
    var referenceRect = state.rects.reference
    var popperRect = state.rects.popper
    var tetaboutffsetValue =
      typeof tetaboutffset === "function"
        ? tetaboutffset(
            Object.assign(
    ...
    if (checkMainAxis) {
      ...
      var minOffset = isBasePlacement
        ? referenceRect[len] / 2 -
          ...
          arrowPaddingMin -
          tetaboutffsetValue
        : minLen - arrowLen - arrowPaddingMin - tetaboutffsetValue
      var maxOffset = isBasePlacement
        ? -referenceRect[len] / 2 +
          ...
          arrowPaddingMax +
          tetaboutffsetValue
        : maxLen + arrowLen + arrowPaddingMax + tetaboutffsetValue
